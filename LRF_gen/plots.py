...
def set_plot_params():
    ...
    params = {'backend': 'ps', 'axes.labelsize': 10, 
              'text.fontsize': 10, 'legend.fontsize': 10,
              'xtick.labelsize': 10, 'ytick.labelsize': 10,
              'text.usetex': True, 'figure.figsize': fig_size, 
              'font.weight': "bolder", 'ytick.major.pad': 10, 
              'xtick.major.pad':10, 'axes.titlesize':10, 
...
def plot_slice(cube, index, filename):
    ...
    plt.subplots_adjust(left = 0.1, right = 0.9, bottom = 0.22,
                        top = 0.95)
